...
class Transaction(db.Model):
    ...
    item_id = db.Column(db.Integer, db.ForeignKey('escrow_order_items.id'), nullable=False)
    ...
    item_details = db.relationship('EscrowOrderItem', backref='transaction', lazy=True)
